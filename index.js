...
const setupUI = (user) => {
  if (user) {
    ...
    chartRef.on('value', snapshot =>{
      ...
      chartT2 = createtemperature2Chart();
      chartT3 = createtemperature3Chart();
      chartT4 = createtemperature4Chart();
      ...
      dbRef.orderByKey().limitToLast(chartRange).on('child_added', snapshot =>{
        ...
        plotValues(chartT3, timestamp, temperature3);
        plotValues(chartT4, timestamp, temperature4);
      });
    });
    ...
    dbRef.orderByKey().limitToLast(1).on('child_added', snapshot =>{
      ...
      temp2Element.innerHTML = temperature2;
      temp3Element.innerHTML = temperature3;
      temp4Element.innerHTML = temperature4;
    ...
    dbRef.orderByKey().limitToLast(1).on('child_added', snapshot =>{
      ...
      //var gaugeT2 = createTemperature2Gauge();
      //var gaugeT3 = createTemperature3Gauge();
      //var gaugeT4 = createTemperature4Gauge();
      ...
      //gaugeT2.value = temperature2;
      //gaugeT3.value = temperature3;
      //gaugeT4.value = temperature4;
      updateElement.innerHTML = epochToDateTime(timestamp);
    });
